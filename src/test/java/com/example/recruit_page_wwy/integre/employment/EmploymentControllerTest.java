...
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.duty[0]").value("REST API 개발 및 유지보수"));
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.duty[1]").value("기존 서비스 코드 리팩토링"));
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.qualification[0]").value("Java/Spring 경력 1년 이상"));
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.qualification[1]").value("MySQL 경험 우대"));
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.employStack[0]").value("Spring"));
//        actions.andExpect(MockMvcResultMatchers.jsonPath("$.body.employStack[1]").value("Java"));
